                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="row">
                                ...
                                <div class="cours-bx">
                                    ...
                                    <div class="cours-more-info">
                                        <div class="review status">
                                            <span class="text-capitalize">On Leave</span>
                                        </div>
                                        <div class="review">
                            ...
                            <div class="col-md-12 heading-bx text-center">
                                <h2 class="title-head text-uppercase m-b0">Alert <br /> <span> There is no on leave faculty members at the moment..!</span></h2>
                            </div>
                            @endif
                        </div>
                    </div>
