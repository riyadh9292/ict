        ...
        <nav class="ttr-sidebar-navi">
            <ul>
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            <a href="{{ route('admin.user.create.index') }}" class="ttr-material-button"><span class="ttr-label">Create New User</span></a>
                        </li>
                        <li>
                            <a href="{{ route('admin.user.index') }}" class="ttr-material-button"><span class="ttr-label">List Users</span></a>
                        </li>
                    </ul>
                </li>
                <li>
